            ...
            <div className="container">
                <div className="flex flex-wrap">
                    <div className="w-full px-4 mb-12 text-slate-300 font-medium md:w-1/3">
                        <img src={Logo} alt="" width="90px" className='mb-3' />
                        <h3 className="font-bold text-2xl mb-2">Contact Us</h3>
                        <p>Jl. Trunojoyo</p>
                        <p>Sampang</p>
                    </div>
                    <div className="w-full px-4 md:w-1/3 mb-8">
                       <h3 className="font-semibold text-xl text-white mb-5">Blog Category</h3>
                       <ul className="text-slate-300">
                         <li>
                            <a href="#Blog" className="inline-block text-base hover:text-ungu mb-3">keyboard review</a>
                         </li>
                         <li>
                            <a href="#Blog" className="inline-block text-base hover:text-ungu mb-3">Unreal Engine</a>
                         </li>
                         <li>
                            <a href="#Blog" className="inline-block text-base hover:text-ungu mb-3">keyboard review</a>
                         </li>
                    ...
                    <div className="w-full px-4 md:w-1/3">
                       ...
                       <ul className="text-slate-300">
                         <li>
                            <a href="#Hero" className="inline-block text-base hover:text-ungu mb-3">Home</a>
                         </li>
                         <li>
                            <a href="#about" className="inline-block text-base hover:text-ungu mb-3">About Me</a>
                         </li>
                         <li>
                            <a href="#Project" className="inline-block text-base hover:text-ungu mb-3">Project</a>
                         </li>
                         <li>
                            <a href="#Client" className="inline-block text-base hover:text-ungu mb-3">CLients</a>
                         </li>
                         <li>
                            <a href="#Blog" className="inline-block text-base hover:text-ungu mb-3">Blog</a>
                         </li>
                         <li>
                            <a href="#Contact" className="inline-block text-base hover:text-ungu mb-3">Contact</a>
                         </li>
                       </ul>
                    </div>
                </div>
